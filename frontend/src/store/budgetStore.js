...
export const useBudgetStore = create((set, get) => ({
	...
	fetchIncomeBudgetAnalysis: async () => {
		try {
			...
			console.error('Error fetching income budget analysis:', error);
			throw error;
		}
	},
	...
	fetchCategoryBudgetSuggestion: async (category) => {
		try {
			...
			console.error('Error fetching category budget suggestion:', error);
			throw error;
		}
	},
	...
	fetchBudgetHealthScore: async () => {
		try {
			...
			console.error('Error fetching budget health score:', error);
			throw error;
		}
	}
}));
